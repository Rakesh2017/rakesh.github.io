  ...
  return (
    <div className="welcome-con">
      ...
      <div className="about-me-con">
        ...
        <p className="info-p">
        🌱 Hi, I'm Rakesh, and I invite you to explore my portfolio. With over 6+ years of experience in Mobile application development, I have honed my skills as a Senior Android Developer. My expertise includes leading development teams, architecting robust mobile solutions, and driving the integration of latest technologies. I excel in optimizing app performance, ensuring seamless user experiences, and delivering high-quality code. 
