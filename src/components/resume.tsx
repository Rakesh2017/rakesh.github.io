...
import resume_image from "../../src/images/rakesh-resume.jpg";
...
export default function Resume() {
  ...
  const resume_download_url = 'https://drive.google.com/file/d/1nYK194sZPg6doAHu3Z-YK-h-ZHFaM1XA/view?usp=sharing'
